...
public class machineListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View recyclerView = findViewById(R.id.machine_list);
    ...
    public static class SimpleItemRecyclerViewAdapter
        ...
        private final View.OnClickListener mOnClickListener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mTwoPane) {
                    ...
                    arguments.putString(machineDetailFragment.ARG_ITEM_ID, item.id);
                    ...
                    intent.putExtra(machineDetailFragment.ARG_ITEM_ID, item.id);
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.machine_list_content, parent, false);
